...
const StoreCard:React.FC<IProductCardProps> = (props: IProductCardProps) => {
  ...
  return (
    <div className="productCard" onClick={() => handleClick(props.product.id)}>
      <div className="productImage" style={{ backgroundImage: `url(${props.product.image})` }}>
      </div>
      <div className="detail">
        ...
        <div className="actions">
          {Boolean(props.product.is_liked) && <Button className="transparent" type="icon"><Liked  width="18px" height="18px" fill="#eb595f"/></Button>}
